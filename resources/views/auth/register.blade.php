...
<head>
    ...
    <title>Register - @if ($dashboard_settings){{ $dashboard_settings->title}} @endif</title>
                                    ...
                                    <div class="center-wrap">
                                        <div class="section text-center">
                                            ...
                                            <form method="POST" action="{{ route('sign-Up.process') }}">
                                                ...
                                                <div class="form-group mt-2">
                                                    <input type="number" name="phone" class="form-style"
                                                ...
                                                <div class="form-group mt-2">
                                                    <input type="password" name="password_confirmation"
                                                        class="form-style" placeholder="Your Confirm Password"
