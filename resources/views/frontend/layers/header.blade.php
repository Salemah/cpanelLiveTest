                        ...
                        <div class="d-menu-wrap">
                            <div class="de-flex sm-pt10">
                                <div class="de-flex-col">
                                    ...
                                    <div id="logo">
                                        <a href="index.html">
                                            <img alt="" class="logo" src="{{asset('arc.jpg')}}" />
                                            <img alt="" class="logo-2" src="{{asset('arc.jpg')}}" />
                                        </a>
                                    </div>
                                    <!-- logo close -->
                                </div>
                                ...
                                <div class="de-flex-col">
                                    <div class="h-phone md-hide"><span>Need&nbsp;Help?</span><i class="fa fa-phone"></i> +8801312648964</div>
