 <nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme"
     ...
     <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
         ...
         <ul class="navbar-nav flex-row align-items-center ms-auto">
             ...
             <!-- Language -->
             <li class="nav-item">
                 <a class="nav-link btn btn-text-secondary"
                     ...
                     <div class="avatar avatar-online">
                                    @if (Auth::user()->image)
                                             ...
                                             <img  src="{{ asset(Auth::user()->image) }}"
                                                 alt="Not Found!" class="h-auto rounded-circle">
                                         @else
                             ...
                             <div class="d-flex align-items-center">
                                 <div class="flex-shrink-0 me-2">
                                     <div class="avatar avatar-online">
                                         ...
                                         @if (Auth::user()->image)
                                             ...
                                             <img class="d-flex mr-3" src="{{ asset(Auth::user()->image) }}"
                                                 alt="Not Found!" class="h-auto rounded-circle">
                                         @else
                                             <img class="rounded-circle" src="{{ asset('assets/img/avatars/1.png') }}"
                                                 alt="Generic user image">
                                 ...
                                 <div class="flex-grow-1">
                                     ...
                                     <small class="text-muted">
                                         @if (Auth::user()->role)
                                             <span class="text">{{ Auth::user()->role }}</span>
                                         @else
                                             <span></span>
                                         @endif
                                     </small>
