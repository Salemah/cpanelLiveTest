...
@section('content')
                        ...
                        <div class="card-header align-items-center justify-content-between d-flex">
                            <nav aria-label="breadcrumb" style="margin-top:-10px;">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Sub Legal Area List</li>
                                </ol>
                            </nav>
                            ...
                            <button class="btn btn-primary btn-sm LegalAreaAddButton"
                                style="float: right;margin-top:-20px;"><i class="fa fa-plus"></i>Sub Legal Area</button>
                        </div>
    ...
    <div class="modal fade" id="LegalArea" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <form id="team_insert_update" action="{{ route('admin.account.sub_legal_area.insert') }}" accept-charset="utf-6"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-6 mb-3">
                                <label for="recipient-name" class="col-form-label">Legal Area<span
                                        class="text-danger">*</span></label>

                                <select name="legal_area_id" id="legal_area_id" class="form-control">
                                    <option value="">Select Status</option>
                                    @foreach ($leaglAreas as $leaglArea)
                                        <option value="{{ $leaglArea->id }}">{{ $leaglArea->name }}</option>
                                    @endforeach
                                </select>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#team_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('admin.account.sub_legal_area.data') }}",
                    type: 'GET',
                    cache: false
                },
                columns: [{
            ...
            $(document).on('click', '.tableDelete', function() {
                ...
                swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: "{{ route('admin.account.sub_legal_area.insert') }}",
                            type: "POST",
                            data: {
            ...
            $(document).on('click', '.tableEdit', function() {
                ...
                $(this).ajaxSubmit({
                    ...
                    dataType: 'json',
                    method: 'GET',
                    url: "{{ route('admin.account.sub_legal_area.edit') }}",
                    success: function(responseText) {
                        ...
                        $('select[name^="legal_area_id"]').val(responseText.data.legal_area_id);
