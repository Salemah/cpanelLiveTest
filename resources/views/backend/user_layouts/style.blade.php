 ...
 <link rel="stylesheet" type="text/css"
    ...
    <link rel="stylesheet"
        href="{{ URL::asset('assets/vendor/libs/datatables-checkboxes-jquery/datatables.checkboxes.css') }}">
         ...
         <link rel="stylesheet" href="{{ URL::asset('assets/datatables/css/responsive.dataTables.min.css') }}">
 <link rel="stylesheet"
        href="{{ URL::asset('assets/vendor/libs/datatables-rowgroup-bs5/rowgroup.bootstrap5.css') }}">
