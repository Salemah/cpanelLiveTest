...
<head>
    ...
    @include('backend.user_layouts.style')
    @yield('css')
...
<body>
    ...
    <div class="layout-wrapper layout-content-navbar  ">
        <div class="layout-container">
            ...
            @include('backend.user_layouts.sidebar')
            <!-- / Menu -->
            <!-- Layout container -->
            <div class="layout-page">
                <!-- Navbar -->

                @include('backend.user_layouts.topbar')
                ...
                <div class="content-wrapper">
                    ...
                    <!-- / Content -->
                    <!-- Footer -->
                    @include('backend.user_layouts.footer')
                    <!-- / Footer -->
    ...
    @include('backend.user_layouts.script')
